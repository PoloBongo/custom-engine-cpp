...
static ImGui_ImplVulkan_Data* ImGui_ImplVulkan_GetBackendData()
{
	return ImGui::GetCurrentContext()
		       ? static_cast<ImGui_ImplVulkan_Data*>(ImGui::GetIO().BackendRendererUserData)
		       : nullptr;
}
...
void ImGui_ImplVulkan_RenderDrawData(ImDrawData* draw_data, VkCommandBuffer command_buffer, VkPipeline pipeline)
{
	...
	if (wrb->FrameRenderBuffers == nullptr)
	{
		...
		wrb->FrameRenderBuffers = static_cast<ImGui_ImplVulkan_FrameRenderBuffers*>(IM_ALLOC(
...
bool ImGui_ImplVulkan_CreateFontsTexture()
{
	...
	bd->FontDescriptorSet = ImGui_ImplVulkan_AddTexture(bd->FontSampler, bd->FontView,
                                             ...
                                             int                       w, int h, uint32_t min_image_count)
{
	...
	// Create Swapchain
	{
		...
		else if (cap.maxImageCount != 0 && info.minImageCount > cap.
		         maxImageCount)
		...
		wd->FrameSemaphores = static_cast<ImGui_ImplVulkanH_FrameSemaphores*>(
