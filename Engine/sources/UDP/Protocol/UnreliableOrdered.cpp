	...
	namespace Network
	{
		namespace UDP
		{
			namespace Protocols
			{
				...
				uint16_t UnreliableOrdered::Multiplexer::serialize(uint8_t* buffer, const uint16_t buffersize, const Datagram::ID)
				{
				...
				void UnreliableOrdered::Demultiplexer::onDataReceived(const uint8_t* data, const uint16_t datasize)
				{
