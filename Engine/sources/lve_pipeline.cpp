...
// est rencontré dans le flux d'indices, une nouvelle primitive est commencée
		...
		_configInfo.multisampleInfo.rasterizationSamples = vk::SampleCountFlagBits::e1;// Choisissez la valeur appropriée en fonction des besoins de qualité d'image et de performances.
