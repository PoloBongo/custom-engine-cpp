...
namespace lve
{
	class VulkanHooks
	{
		...
		public:
			...
			void SetVertexBufferMemory(vk::DeviceMemory* _vertexBufferMemory)
			{
				this->vertexBufferMemory = _vertexBufferMemory;
			}

			void SetIndexBuffer(vk::Buffer* _indexBuffer) { this->indexBuffer = _indexBuffer; }

			void SetIndexBufferMemory(vk::DeviceMemory* _indexBufferMemory)
			{
				this->indexBufferMemory = _indexBufferMemory;
			}

			void SetUniformBuffer(vk::Buffer* _uniformBuffer) { this->uniformBuffer = _uniformBuffer; }

			void SetUniformBufferMemory(vk::DeviceMemory* _uniformBufferMemory)
			{
				this->uniformBufferMemory = _uniformBufferMemory;
			}

			void SetDescriptorSetLayout(vk::DescriptorSetLayout* _descriptorSetLayout)
			{
				this->descriptorSetLayout = _descriptorSetLayout;
			}
