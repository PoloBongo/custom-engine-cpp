...
namespace lve {
    ...
    public:
        ...
        public:
             ...
             */
            Builder& AddBinding(uint32_t _binding, vk::DescriptorType _descriptorType, vk::ShaderStageFlags _stageFlags, uint32_t _count = 1);
        ...
        private:
            LveDevice& lveDevice; /**< Une référence vers l'objet LveDevice utilisé pour la création de la mise en page de l'ensemble de descripteurs. */
            std::unordered_map<uint32_t, vk::DescriptorSetLayoutBinding> bindings{}; /**< Les bindings ajoutés à la mise en page de l'ensemble de descripteurs. */
        };
         ...
         */
        LveDescriptorSetLayout( LveDevice& _lveDevice, std::unordered_map<uint32_t, vk::DescriptorSetLayoutBinding> _bindings);
    ...
    private:
        ...
        std::unordered_map<uint32_t, vk::DescriptorSetLayoutBinding> bindings; /**< Map des bindings de l'ensemble de descripteurs. */
 ...
 */
        ...
        private:
            ...
            uint32_t maxSets; /**< Nombre maximal d'ensembles de descripteurs pouvant être alloués à partir du pool. */
            vk::DescriptorPoolCreateFlags poolFlags; /**< Indicateurs de création du pool de descripteurs. */
            std::vector<vk::DescriptorPoolSize> poolSizes; /**< Vecteur contenant les tailles de pool de descripteurs. */
    ...
    private:
        ...
        friend class LveDescriptorWriter; /**< Permet à la classe LveDescriptorWriter d'accéder aux membres privés. */
